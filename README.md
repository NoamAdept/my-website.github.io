...
<head>
  ...
  <title>Noam Yakar – CS & Math Graduate</title>
  <style>
    :root {
      --bg: #f5f7fa;
      --accent: #0a66c2;
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .hero h1 { font-size: 2.5rem; color: var(--heading); margin-bottom: 0.5rem; }
    .hero p { color: var(--light); font-size: 1.1rem; }
    ...
    .education-item, .skill-list-item {
      background: white;
      padding: 1rem;
      border-radius: 4px;
    ...
    <section id="projects">
      ...
      <div class="projects-grid">
        ...
        <div class="project-card">
          ...
          <p>Top-10 finisher in program & system security track; challenges in ROP, shellcode, sandboxing, etc.</p>
          <div class="project-links">
